...
.doc_header a { color:rgb(51, 51, 51); }
.doc_header a:hover { color:rgb(255, 51, 0); }
...
.toplinks ul.isuser .notifications .popupbody {
	background: #0068B3;
	border: 1px solid #0068B3; /* makes it look consistent with the popup background */
}
...
.toplinks ul.isuser .notifications .popupbody li a{
	...
	padding: 0 5px;
	font-weight: normal;
	border-top:1px solid #0068B3; /* makes it look consistent with the popup background */
	text-align: left;
	padding-left: 30px;
	line-height: 26px;
}
...
.navtabs {
	background:#0068B3 url(images/buttons/newbtn_middle.png) repeat-x  ;
...
.navtabs li a.navtab:hover {
	background:#65bad3 url(images/gradients/selected-tab-gradient-with-top-alpha.png) repeat-x   0 -4px;
	color:#000000;
}
...
.navtabs li.selected a.navtab {
	color:#000000;
	background:#65bad3 url(images/gradients/selected-tab-gradient-with-top-alpha.png) repeat-x  ;
	position:relative;
	top:-4px;
	padding-top:4px;
	z-index:10;
